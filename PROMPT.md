# SAMRA Project - AI Assistant Instructions

## Project Overview

**Project Name:** SAMRA  
**Type:** SaaS Website Builder  
**Focus:** No-code 3D animated landing pages with real-time collaboration
...
SAMRA is a visual website builder (like Webflow) specialized in creating stunning 3D animated landing pages using Three.js, without requiring users to write code. It features Google Docs-style real-time collaboration and targets non-technical users (marketers, agencies, indie hackers).
...
You are helping build SAMRA. For each task:
...
4. **Follow the tech stack** specified above
5. **Consider mobile performance** in every decision
6. **Think about non-technical users** in UX choices
7. **Write tests** for critical functionality
8. **Optimize for real-world use** (not just demos)

### Response Format

When providing code:
```typescript
// ✅ Good: Complete, working code with comments
// ❌ Bad: Partial code with "// TODO" placeholders
```
...
**Purpose:** Displays grid of pre-built templates with live previews

**Props:**
- `onSelect: (templateId: string) => void` - Called when user picks template
- `filters?: string[]` - Optional category filters

**Usage:**
[code example]

**Performance:** Uses virtual scrolling for 100+ templates
```
...
- User may not know Three.js deeply
- User may not know Convex API
- Explain complex concepts simply

### Prioritize UX
- Every feature must be usable by non-developers
- If it requires explanation, simplify it
- Test with "mom test" - could your mom use it?
...
**Status:** Project setup complete. Ready to begin Phase 1.

**Waiting for:** User to provide specific task or ask to begin Phase 1 (Landing Page with 3D Hero).

**Available commands:**
- "Begin Phase 1" - Start building marketing landing page
- "Explain [concept]" - Get detailed explanation of any part
- "Show me [example]" - See code example for specific feature
- "Review setup" - Verify all tools configured correctly

---

## Questions Before Starting?

Before we begin coding, do you want to:
1. Review the architecture?
2. Discuss any technical decisions?
3. Modify the tech stack?
4. Change the development phases?
